      ...
      <Card className="glass rounded-2xl shadow-card">
        <CardContent className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            >
              <Link href="/generate">
                <PlusCircle className="mr-2 h-4 w-4" /> Generate a new course
              </Link>
            </Button>
            <Button
              asChild
              ...
              className="h-12 rounded-2xl"
            >
              <Link href="/generate-ai">
                <Bot className="mr-2 h-4 w-4" /> Generate course with AI
              </Link>
            </Button>
            <Button
              asChild
              variant="outline"
              size="lg"
              className="h-12 rounded-2xl bg-gradient-to-r from-indigo-600 to-violet-600 text-white shadow-soft hover:shadow-card"
            >
              <Link href="/practice">
                <Play className="mr-2 h-4 w-4" /> Take a course
              </Link>
            </Button>
          </div>
        </CardContent>
